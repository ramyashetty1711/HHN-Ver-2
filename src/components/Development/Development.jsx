...
export default function Development() {
  return (
    <div className=" mx-auto px-4 py-8 space-y-2">
      <div className="bg-white px-6 py-2 rounded-lg shadow-lg border-l-4 border-[var(--secondary)] mb-2">
      ...
      <div className="bg-white px-6 py-2 rounded-lg shadow-lg border-l-4 border-[var(--secondary)] "> 
        <h2 className="text-xl font-bold text-[var(--heading)] my-2 flex justify-center">
      ...
      <div className="grid grid-cols-12 gap-2 items-start">
        ...
        {/* Text Column */}
        <div className="col-span-12 md:col-span-9 bg-white p-6 rounded-lg shadow-lg border-l-4 border-[var(--secondary)] mb-2">
          <h2 className="text-xl font-bold text-[var(--heading)] my-2 flex justify-center">
