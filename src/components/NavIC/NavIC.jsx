  ...
  return (
    <div className=" w-[99.9%] flex flex-col bg-white py-3 px-6 h-full overflow-y-auto custom-scrollbar">
      ...
      <div className="relative">
        ...
        <button
          className="absolute md:top-1/2 top-1/4 left-0 z-10 text-2xl text-gray-1000 cursor-pointer"
        ...
        {/* Custom Next Arrow */}
        <button
          className="absolute md:top-1/2 top-1/4 right-0 z-10 text-2xl text-gray-1000 cursor-pointer"
